### T1027.003 - Data Exfiltration

- **ID**: T1027.003  
- **Technique**: Data Exfiltration  
- **Description**:  
  Data exfiltration refers to the unauthorized transfer of sensitive data from an internal environment to an external one. Adversaries typically use various methods to bypass detection and exfiltrate data, such as:

  - **Cloud Storage**: Uploading stolen data to legitimate cloud services like Google Drive, Dropbox, or others.
  - **Email**: Sending data as email attachments, often in encrypted or compressed formats to avoid detection.
  - **File Transfer Protocols (FTP/SFTP)**: Using FTP or other file transfer protocols to transfer data externally.
  - **Physical Media**: Copying data to USB drives or other removable storage devices to physically remove it from the system.
  - **Encrypted Channels**: Using encrypted protocols (like HTTPS) to avoid detection by security tools or network monitoring.

  The goal of data exfiltration is typically to steal sensitive information like intellectual property, credentials, or personal data without triggering alerts or being noticed by security systems.
...
## Additional Info / Reference Links

- [MITRE ATT&CK - T1027.003: Data Exfiltration](https://attack.mitre.org/techniques/T1027/003/)
- [Steghide - Tool for Steganography](https://steghide.sourceforge.net/)
- [7-Zip - File Compression Software](https://www.7-zip.org/)
- [Cloud Security: Protecting Data in the Cloud](https://www.cio.com/article/259594/cloud-security-protecting-your-data-in-the-cloud/)
- [Best Practices for Data Exfiltration Prevention](https://www.csoonline.com/article/3327689/what-is-data-exfiltration-and-how-to-prevent-it.html)
